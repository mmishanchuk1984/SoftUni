...
from exam_prep1.web.forms import CreateProfileForm, EditProfileForm, DeleteProfileForm, CreateExpenseForm, \
    EditExpenseForm, DeleteExpenseForm
from exam_prep1.web.models import Profile, Expense
...
def show_index(request):
    ...
    context = {'budget_left': budget_left, 'profile': profile, 'expenses': expenses}
